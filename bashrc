...
if [ "$force_color_prompt" = yes ] && [ "$color_support" = yes ]; then
    PS1='${debian_chroot:+($debian_chroot)}\[\033[01;33m\]\u@\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[01;36m\]\$ \[\033[00m\]'
else
...
if [ "$color_support" = yes ] && [ -x /usr/bin/dircolors ]; then
